package resonator.server.email
...
class EmailClient @Inject()(configuration: Configuration)(implicit ec: ExecutionContext)
  ...
  private val mailgunDomain = configuration.get[String]("resonator.email.mailgun.domain")
  private val mailgunApiKey = configuration.get[String]("resonator.email.mailgun.apikey")
